...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String databasePath = "C:\\Users\\930yu\\Desktop\\streetlight.db"; // 데이터베이스 경로
    private static String databaseName = "streetlight.db"; // 데이터베이스 이름
    private static String tableName = "GwangjinStreetLight"; // 테이블 이름
